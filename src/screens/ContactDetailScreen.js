...
const makeStyles = (COLORS) => StyleSheet.create({
  ...
  headerTitle: { flex: 1, fontSize: 17, fontWeight: '700', textAlign: 'center', color: COLORS.dark },
  editBtn: { padding: 4, width: 40, alignItems: 'flex-end' },
  profile: { alignItems: 'center', paddingTop: 30, paddingBottom: 16 },
  avatar: {
    width: 80, height: 80, borderRadius: 22, backgroundColor: COLORS.accent,
    alignItems: 'center', justifyContent: 'center', overflow: 'hidden',
  },
  avatarBirthday: {
    backgroundColor: COLORS.birthday,
    shadowColor: COLORS.birthday, shadowOffset: { width: 0, height: 0 },
    shadowOpacity: 0.4, shadowRadius: 16, elevation: 6,
  },
  avatarText: { color: COLORS.white, fontSize: 28, fontWeight: '700' },
  avatarImage: { width: '100%', height: '100%' },
  name: { fontSize: 22, fontWeight: '700', color: COLORS.dark, marginTop: 14 },
  jobLine: { fontSize: 14, color: COLORS.gray, marginTop: 4 },
  birthdayBadge: {
  ...
  actionBtn: {
    alignItems: 'center', gap: 4, backgroundColor: COLORS.accentLight,
    paddingHorizontal: 20, paddingVertical: 12, borderRadius: 14,
  },
  actionLabel: { fontSize: 11, fontWeight: '600', color: COLORS.accent },
  details: { paddingHorizontal: 24, paddingTop: 8 },
  detailRow: { paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: COLORS.border },
  detailLabel: {
